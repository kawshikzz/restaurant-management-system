...
global $conn;
	...
	$ConfirmNewPassword = clean($_POST['cpassword']);
     ...
     if (isset($_GET['id']))
     {
         ...
         // update the entry
         $result = mysqli_query($conn,"UPDATE cafe_cook SET password='$NewPassword' WHERE cook_id='$id' AND password='$OldPassword'")
         or die("The cook does not exist ... \n". mysqli_error()); 
         
         // redirect back to the member profile
         header("Location: cook-profile.php");
     }
     else
