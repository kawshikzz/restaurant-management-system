...
<hr>
<div id="container">
<form name="partyhallForm" id="partyhallForm" method="post" action="admin-reserve-exec.php?id=<?php echo $_SESSION['SESS_MEMBER_ID'];?>" onsubmit="return partyhallValidate(this)">
